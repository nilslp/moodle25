 ...
 */
    ...
    function get_group_items() {
        ...
        if($items = $DB->get_records('report_builder_group_assign',
    ...
    function disable_item($item) {
        ...
        if($record = $DB->get_record('report_builder_preproc_track',
    ...
    function get_track_info() {
        ...
        $trackinfo = $DB->get_records('report_builder_preproc_track',
