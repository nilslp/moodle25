...
class filter_number extends filter_type {
    ...
    function getOperators() {
        return array(0 => get_string('isequalto', 'filters'),
                     ...
                     2 => get_string('isgreaterthan','block_lp_reportbuilder'),
                     3 => get_string('islessthan','block_lp_reportbuilder'),
                     4 => get_string('isgreaterorequalto','block_lp_reportbuilder'),
                     5 => get_string('islessthanorequalto','block_lp_reportbuilder'));
    }
