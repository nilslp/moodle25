...
var rb_get_btn_add = function (reportid) {
    return $('<a href="<?php echo $CFG->wwwroot.'/blocks/lp_reportbuilder/filters.php?id='; ?>' + reportid + '" class="addfilterbtn"><input type="button" value="Add" /></a>');
};
...
var rb_init_addbutton = function(filterselector) {
    ...
    addbutton.bind('click', function(e) {
        e.preventDefault();
        $.ajax({
            url: "<?php echo $CFG->wwwroot.'/blocks/lp_reportbuilder/ajax/filter.php'; ?>",
            type: "POST",
...
var rb_init_deletebuttons = function() {
    ...
    $('.reportbuilderform table .deletefilterbtn').bind('click', function(e) {
        ...
        confirmed = confirm('<?php echo addslashes_js(get_string('confirmfilterdelete', 'block_lp_reportbuilder')); ?>');
        ...
        $.ajax({
            ...
            beforeSend: function() {
                clickedbtn.replaceWith('<img src="<?php echo "{$CFG->wwwroot}/pix/i/ajaxloader.gif"; ?>" alt="Deleting..." class="iconsmall" />');
            },
            success: function(o) {
                if (o.length > 0) {
...
var rb_init_movedown_btns = function() {
    ...
    $('.reportbuilderform table .movefilterdownbtn').bind('click', function(e) {
        ...
        var loadingimg = '<img src="<?php echo "{$CFG->wwwroot}/pix/i/ajaxloader.gif"; ?>" alt="Moving..." class="iconsmall" />';
...
var rb_get_btn_delete = function(reportid, fid) {
    return $('<a href="<?php echo $CFG->wwwroot.'/blocks/lp_reportbuilder/filters.php?id='; ?>' + reportid + '&fid='+fid+'&d=1" class="deletefilterbtn"><img src="<?php echo "{$CFG->wwwroot}/pix/t/delete.gif"; ?>" alt="Delete" class="iconsmall" /></a>');
};

var rb_get_btn_up = function (reportid, fid) {
    return $('<a href="<?php echo $CFG->wwwroot.'/blocks/lp_reportbuilder/filters.php?id='; ?>' + reportid + '&fid='+fid+'&m=up" class="movefilterupbtn"><img src="<?php echo "{$CFG->wwwroot}/pix/t/up.gif"; ?>" alt="Move up" class="iconsmall" /></a>');
};

var rb_get_btn_down = function (reportid, fid) {
    return $('<a href="<?php echo $CFG->wwwroot.'/blocks/lp_reportbuilder/filters.php?id='; ?>' + reportid + '&fid='+fid+'&m=down" class="movefilterdownbtn"><img src="<?php echo "{$CFG->wwwroot}/pix/t/down.gif"; ?>" alt="Move down" class="iconsmall" /></a>');
};
