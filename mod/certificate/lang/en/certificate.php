...
$string['borderstyle_help'] = 'The Background Image option allows you to choose a background image from the certificate/pix/borders folder.  Select the background image that you want on the certificate or select no.  Recommended dimensions - height: 1122px, width: 793px';
...
$string['onthisdate'] = 'on this date';
...
$string['typelp_centered_non_embedded'] = 'A4 Centered Non-Embedded';
$string['typelp_left_non_embedded'] = 'A4 Left Justified Non-Embedded';
...
$string['heading:certwording'] = 'Certificate Wording';