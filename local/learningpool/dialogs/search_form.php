...
class dialog_search_form extends moodleform {
    ...
    function definition() {
        ...
        if ($hierarchy && $showpicker) {
            ...
            $attr = array(
                'class' => 'lp-limited-width-150',
                'onMouseDown'=>"if(document.all) this.className='lp-expanded-width';",
                'onBlur'=>"if(document.all) this.className='lp-limited-width-150';",
                'onChange'=>"if(document.all) this.className='lp-limited-width-150';"
            );
