...
// Dialog object
function lpDialog(title, buttonid, config, default_url, handler) {
    ...
    this.setup = function() {
        ...
        var default_config = {
            ...
            resizable: false,
            zIndex: 1500,
            dialogClass: 'lp-dialog'
        };

        // Instantiate the Dialog
        $('<div class="lp-dialog" style="display: none;"><div id="'+this.title+'"></div></div>').appendTo($('body'));
 ...
 * @return void
 */
lpDialog_handler.prototype._setup = function(dialog) {
    this._dialog = dialog;
 ...
 * @return void
 */
lpDialog_handler.prototype._load = function(dialog) {
 ...
 * @return void
 */
lpDialog_handler.prototype._update = function(response) {
 ...
 * @return array
 */
lpDialog_handler.prototype._get_ids = function(elements, prefix) {
 ...
 * @return void
 */
lpDialog_handler.prototype._save = function(url) {
 ...
 * @return void
 */
lpDialog_handler.prototype._cancel = function() {
    this._dialog.hide();
    return;
}
 ...
 * @return void
 */
lpDialog_handler.prototype._set_framework = function() {
...
/*****************************************************************************/
/** lpDialog_handler_treeview **/

lpDialog_handler_treeview = function() {};

lpDialog_handler_treeview.prototype = new lpDialog_handler();
 ...
 * @return void
 */
lpDialog_handler_treeview.prototype.setup_tabs = function(e, ui) {
 ...
 * @return void
 */
lpDialog_handler_treeview.prototype.first_load = function() {
 ...
 * @return void
 */
lpDialog_handler_treeview.prototype._partial_load = function(parent_element) {
 ...
 * @return void
 */
lpDialog_handler_treeview.prototype._make_hierarchy = function(parent_element) {
    var handler = this;
 ...
 * @return void
 */
lpDialog_handler_treeview.prototype._update_hierarchy = function(response, parent_id) {
    var items = response;
 ...
 * @return void
 */
lpDialog_handler_treeview.prototype._toggle_items = function(elid, type) {
 ...
 * @return void
 */
lpDialog_handler_treeview.prototype._make_deletable = function(parent_element) {
 ...
 * @return void
 */
lpDialog_handler_treeview.prototype._append_to_selected = function(element) {
...
/*****************************************************************************/
/** lpDialog_handler_treeview_multiselect **/

lpDialog_handler_treeview_multiselect = function() {};
lpDialog_handler_treeview_multiselect.prototype = new lpDialog_handler_treeview();
 ...
 * @return void
 */
lpDialog_handler_treeview_multiselect.prototype.every_load = function() {
 ...
 * @return void
 */
lpDialog_handler_treeview_multiselect.prototype._make_selectable = function(parent_element) {
 ...
 * @return void
 */
lpDialog_handler_treeview_multiselect.prototype._handle_update_hierarchy = function(parent_element) {
    this._make_selectable(parent_element);
}


/*****************************************************************************/
/** lpDialog_handler_treeview_singleselect **/

lpDialog_handler_treeview_singleselect = function(value_element_name, text_element_id, dualpane) {
...
lpDialog_handler_treeview_singleselect.prototype = new lpDialog_handler_treeview();
 ...
 * @return void
 */
lpDialog_handler_treeview_singleselect.prototype._handle_update_hierarchy = function(parent_element) {
    this._make_selectable(parent_element);
}
 ...
 * @return void
 */
lpDialog_handler_treeview_singleselect.prototype.first_load = function() {

    // Setup dialog
    lpDialog_handler_treeview.prototype.first_load.call(this);
 ...
 * @return void
 */
lpDialog_handler_treeview_singleselect.prototype.every_load = function() {

    this._make_selectable($('.treeview', this._container));
}

lpDialog_handler_treeview_singleselect.prototype._set_current_selected = function() {
 ...
 * @return void
 */
lpDialog_handler_treeview_singleselect.prototype._save = function() {
    dialog = this;
 ...
 * @return void
 */
lpDialog_handler_treeview_singleselect.prototype._make_selectable = function(parent_element) {
...
/*****************************************************************************/
/** lpDialog_handler_skeletalTreeview **/

lpDialog_handler_skeletalTreeview = function() {};
lpDialog_handler_skeletalTreeview.prototype = new lpDialog_handler_treeview();
 ...
 * @return void
 */
lpDialog_handler_skeletalTreeview.prototype.every_load = function() {
 ...
 * @return void
 */
lpDialog_handler_skeletalTreeview.prototype._make_hierarchy = function(parent_element) {
    var handler = this;
 ...
 * @return void
 */
lpDialog_handler_skeletalTreeview.prototype._update_hierarchy = function(response, parent_id) {
...
* @return void
*/
lpDialog_handler_skeletalTreeview.prototype._make_selectable = function(elements, addclickable) {
    var handler = this;
 ...
 * @return void
 */
lpSingleSelectDialog = function(name, title, find_url, value_element, text_element, handler_extra) {

    var handler = new lpDialog_handler_treeview_singleselect(value_element, text_element);
 ...
 * @return void
 */
lpMultiSelectDialog = function(name, title, find_url, save_url) {

    var handler = new lpDialog_handler_treeview_multiselect();
