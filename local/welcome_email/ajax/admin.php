...
if (!isloggedin() || !has_capability('local/welcome_email:config', $context)){
...
$results['total'] = get_welcomeemail_user_count($search, $status-1);
$results['start'] = $start;
$results['data'] = get_welcomeemail_users($search, $status-1, $start, $perpage, $sort);
