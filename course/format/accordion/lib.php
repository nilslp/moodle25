 ...
 */
function callback_accordion_uses_sections() {
    return true;
}
 ...
 * @return bool Returns true
 */
function callback_accordion_load_content(&$navigation, $course, $coursenode) {
 ...
 * @return string
 */
function callback_accordion_definition() {
    return get_string('accordion','format_accordion');
}
 ...
 * @return string
 */
function callback_accordion_request_key() {
    return 'accordion';
}

function callback_accordion_get_section_name($course, $section) {
    // We can't add a node without any text
    if ((string)$section->name !== '') {
        return format_string($section->name, true, array('context' => get_context_instance(CONTEXT_COURSE, $course->id)));
    } else if ($section->section == 0) {
        return get_string('section0name', 'format_accordion');
    } else {
        return get_string('sectionname','format_accordion').' '.$section->section;
    }
}
 ...
 * @return stdClass
 */
function callback_accordion_ajax_support() {
 ...
 * @return moodle_url
 */
function callback_accordion_get_section_url($courseid, $sectionnum) {
