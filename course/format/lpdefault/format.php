...
// Display the whole course as "lpdefault" made of of modules
...
if ($thissection->summary or $thissection->sequence or $PAGE->user_is_editing()) {
    ...
    print_section($course, $thissection,null,null);
...
$section = 1;
$sectionmenu = array();
$lpdefaultsections = array('elearning','quiz','certificate','discussion');
$defaultcount = count($lpdefaultsections);
//$lpdefaultsections= array('elearning','quiz','certificate','discussion');
if($course->numsections < $defaultcount) $course->numsections==$defaultcount;
foreach($lpdefaultsections as $lpsection){
	...
	switch($lpsection){
	case 'elearning':
		$thissection->summary = "<p>&lt;&lt;Enter text description here&gt;&gt;</p>";
		break;
	case 'quiz':
		$thissection->summary = "<p>&lt;&lt;Quiz information goes here&gt;&gt;</p>";
		break;
	case 'certificate':
		$thissection->summary = "<p>&lt;&lt;Certfiicate&gt;&gt;</p>";
		break;
	case 'discussion':
		$thissection->summary = "<p>&lt;&lt;Enter text description here&gt;&gt;</p>";
		break;
    ...
    if ($showsection) {
        ...
        if (!has_capability('moodle/course:viewhiddensections', $context) and !$thissection->visible) {   // Hidden for students
            ...
            echo '<div class="summary">';
	//put image here
            echo '<img height="26" alt="'.$lpsection.'" src="'.$OUTPUT->pix_url('i/lpdefault_'.$lpsection) .'">';								
            if ($thissection->summary) {
                $coursecontext = get_context_instance(CONTEXT_COURSE, $course->id);
                $summarytext = file_rewrite_pluginfile_urls($thissection->summary, 'pluginfile.php', $coursecontext->id, 'course', 'section', $thissection->id);
                $summaryformatoptions = new stdClass();
...
//add other sections after default
