...
/*class theme_ubertheme_block_controls_renderer extends core_renderer{
	
		// This function renders the block command markup
...
//$output .= html_writer::tag('div', html_writer::tag('div', $title, array('class' => 'title'))  . html_writer::tag('div', '', array('class'=>'block_action')) . $controlshtml, array('class' => 'header'));


//$output .= html_writer::tag('div', html_writer::tag('div', html_writer::tag('div', '', array('class'=>'block_action')). $title . $controlshtml, array('class' => 'title')), array('class' => 'header'));

$output .= html_writer::tag('div', html_writer::tag('div', $title . html_writer::tag('div',  html_writer::tag('div', '', array('class'=>'block_action')) . $controlshtml, array('class' => 'actions-commands')), array('class' => 'title')), array('class' => 'header'));
			}
			return $output;
