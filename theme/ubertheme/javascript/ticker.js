M.theme_ubertheme.ticker = function(Y) {
    ...
    cfg.ticker_padding = (parseInt(ticker.getStyle('paddingBottom')) + parseInt(ticker.getStyle('paddingTop')));
    cfg.ticker_border = parseInt(ticker.getStyle('borderBottomWidth'), 10);
    cfg.actual_height = cfg.ticker_height - cfg.ticker_border - cfg.ticker_padding;
