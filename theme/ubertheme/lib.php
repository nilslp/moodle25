...
class ubertheme_admin_setting_startgroup extends admin_setting {
    ...
    public function output_html($data, $query='') {
        ...
        $html = '<fieldset class="admin-setting-group '.$this->group_name.'">';
        return $html;
    }
...
class ubertheme_admin_setting_endgroup extends admin_setting {
...
function ubertheme_searchWidget() {
    ...
    $html.= '<input type="text" value="" name="search" placeholder="'.get_string('label:searchwidget_input', 'theme_ubertheme').'">';
    $html.= '<button type="submit">'.get_string('label:searchwidget_button','theme_ubertheme').'</button>';
    $html.= '</fieldset>';
    $html.= '</form>';
    $html.= '</div>';
...
function ubertheme_renderSupportWidget() {
...
function theme_ubertheme_init_yui() {
    ...
    if (file_exists($CFG->dirroot . '/theme/ubertheme/javascript/yui-init.js')) {
        $ubertheme_config = theme_config::load('ubertheme');
        $yuimods = (isset($ubertheme_config->javascripts['yuimods'])) ? $ubertheme_config->javascripts['yuimods'] : array('node');
        $jsconfig = array(
        ...
        // Required for LP Course Category List
...
class LPQuickForm_ubertheme_checkbox extends HTML_QuickForm_checkbox {

    var $_desc = '';

    function LPQuickForm_ubertheme_checkbox($elementName=null, $elementLabel=null, $text=null, $attributes=null, $desc=null) {
...
class LPQuickForm_ubertheme_editor extends MoodleQuickForm_editor {

    var $_desc = '';

    function LPQuickForm_ubertheme_editor($elementName=null, $elementLabel=null, $attributes=null, $options=null, $desc=null) {
...
class LPQuickForm_ubertheme_textarea extends HTML_QuickForm_textarea {

    var $_desc = '';

    function LPQuickForm_ubertheme_textarea($elementName=null, $elementLabel=null, $attributes=null, $desc=null) {
...
class LPQuickForm_ubertheme_select extends HTML_QuickForm_select {

    var $_desc = '';

    function LPQuickForm_ubertheme_select($elementName=null, $elementLabel=null, $options=null, $attributes=null, $desc=null) {
...
class LPQuickForm_ubertheme_colorpicker extends HTML_QuickForm_text {

    var $_desc = '';
    var $_attr = '';

    function LPQuickForm_ubertheme_colorpicker($elementName=null, $elementLabel=null, $attributes=null, $desc=null) {
...
require_once($CFG->dirroot.'/lib/pear/HTML/QuickForm/text.php');
class LPQuickForm_ubertheme_text extends HTML_QuickForm_text {

    var $_desc = '';

    function LPQuickForm_ubertheme_text($elementName=null, $elementLabel=null, $attributes=null, $desc=null) {
...
class LPQuickForm_ubertheme_static extends HTML_QuickForm_static {

    function LPQuickForm_ubertheme_static($elementName=null, $elementLabel=null, $text=null) {
...
class LPQuickForm_ubertheme_filepicker extends MoodleQuickForm_filepicker {

    var $_desc = '';

    function LPQuickForm_ubertheme_filepicker($elementName=null, $elementLabel=null, $attributes=null, $options=null, $desc=null) {
...
class LPQuickForm_ubertheme_filemanager extends MoodleQuickForm_filemanager {

    var $_desc = '';

    function LPQuickForm_ubertheme_filemanager($elementName=null, $elementLabel=null, $attributes=null, $options=null, $desc=null) {
...
// Toggle secure request to themes.learningpool.com images only
    ...
    if (!$banner_setting) {
        ...
        $html.= '<ul class="bg">';
        $html.= '<li style="opacity: 0; position: absolute;"><img class="default-banner" src="'.$OUTPUT->pix_url('banner_default_1', 'theme').'" alt="banner"/></li>';
        $html.= '<li style="opacity: 0; position: absolute;"><img class="default-banner" src="'.$OUTPUT->pix_url('banner_default_2', 'theme').'" alt="banner"/></li>';
        $html.= '<li style="opacity: 1; position: relative;"><img class="default-banner" src="'.$OUTPUT->pix_url('banner_default_3', 'theme').'" alt="banner"/></li>';
        $html.= '</ul>';
        $html.= '</div>';
