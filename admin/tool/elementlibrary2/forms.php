...
$url = new moodle_url('/admin/tool/elementlibrary2/forms.php');
...
$urls = array(
    '/admin/tool/elementlibrary2/' => 'Index',
    '/admin/tool/elementlibrary2/common.php' => 'Common elements',
    '/admin/tool/elementlibrary2/mform.php' => 'Moodle form elements',
    '/admin/tool/elementlibrary2/tables.php' => 'Tables',
    '/admin/tool/elementlibrary2/tabs.php' => 'Tabs',
);
