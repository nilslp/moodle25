...
$url = new moodle_url('/admin/tool/elementlibrary2/mform_standard.php');
...
class standard_form_elements extends moodleform {
    ...
    function definition() {
        ...
        $mform->addElement('selectwithlink', 'selectwithlinkfield', 'Select with link', array(1 => 'One', 2 => 'Two', 3 => 'Three'), null, array('link' => $CFG->wwwroot.'/admin/tool/elementlibrary2/', 'label' => 'A label'));
