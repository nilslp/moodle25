...
$url = new moodle_url('/admin/tool/elementlibrary2/example.php');
...
$PAGE->requires->css('/admin/tool/elementlibrary2/google-code-prettify/prettify.css');
$PAGE->requires->js('/admin/tool/elementlibrary2/google-code-prettify/prettify.js');
$PAGE->requires->js_init_call('M.tool_elementlibrary2.prettyprint');
